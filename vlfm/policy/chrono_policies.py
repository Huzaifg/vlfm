...
class ChronoMixin:
    ...
    _observations_cache: Dict[Any, Any] = {}
    _policy_info: Dict[Any] = {}
    ...
    def act(self, observations: TensorDict, rnn_hidden_states: Any, prev_actions: Any, masks: Tensor, deterministic: bool = False) -> Tuple[Tensor, Any]:
    ...
    def _cache_observations(self: BaseObjectNavPolicy, observations: TensorDict) -> None:
